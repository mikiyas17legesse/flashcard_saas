      ...
      <Box sx={{ my: 6 }}>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography>
              Access your flashcards from anywhere, on any device. Study on the
              go with ease.
            </Typography>
          </Grid>
          <Grid item xs={12} md={4}>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            >
              ...
              <Typography>
                Access to more flashcard features and increased amount of
                storage.
              </Typography>
              <Button
                variant="contained"
          ...
          <Grid item xs={12} md={4}>
            ...
            >
              ...
              <Button
                ...
                color="primary"
                sx={{ mt: 2 }}
                onClick={() => handleSubmit("price_expert")}
              >
                Choose Expert
              </Button>
            </Box>
